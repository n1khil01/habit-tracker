      ...
      <div style={outerStyle}>
        <div style={cardStyle}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div>
              <label style={labelStyle}>Password</label>
              <input type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)}   onKeyDown={(e) => e.key === "Enter" && register()} style={inputStyle} />
            </div>
      ...
      <div style={outerStyle}>
        <div style={cardStyle}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <div>
              <label style={labelStyle}>Email</label>
              <input type="email" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)}  onKeyDown={(e) => e.key === "Enter" && forgotPassword()} style={inputStyle} />
            </div>
